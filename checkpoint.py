...
def load_and_check_checkpoint(ckpt_path,save=False):
    ...
    try:
        ...
        try:
            # print('this checkpoint v.1 is deprecated, convert this version to v.3 using from muat.checkpoint import convert_checkpoint_v2tov3 function')
            checkpoint = load_checkpoint_v3(ckpt_path)
            return checkpoint
        except Exception as e2:
            raise ValueError('The checkpoint you provided is deprecated. Convert with the following function: from muat.checkpoint import convert_checkpoint_v2tov3. Or choose any from the downloaded checkpoint here: ' + str(e) + str(e2))
